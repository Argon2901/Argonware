    ...
    <body>
        ...
        <table>
            ...
            <tr>
                <th>Description</th>
                <td><pre>
A website created to give a personal flair to my work, as well as to 
motivate me to learn website building. The server is configured by 
me and hosted on a personal server. The website is built using html/css, 
with PHP serving as the backend.
                </pre></td>
            </tr>
            <tr>
                <th>Status</th>
